...
write.table(snps_res, "/restricted/projectnb/pulmseq/Allegro/Bronch_microRNA/edrn243/Analysis/LGRC_sandbox/LGRC_Data/Preprocess/snps_res.csv", row.names=FALSE, sep=",")
...
# cis SNP ild
snpname <- "kgp7779523_T" #"rs618555_T" #"rs618555_T" #"kgp7779523_T"
snp1.ctr <- snp.overlap.ctr[snpname,which(snp.overlap.ctr[snpname,]==1)]
snp2.ctr <- snp.overlap.ctr[snpname, which(snp.overlap.ctr[snpname,]==2)]
snp.ctr <- snp.overlap.ctr[snpname, which(snp.overlap.ctr[snpname,]==1 | snp.overlap.ctr[snpname,]==2)]
nosnp.ctr <- snp.overlap.ctr[snpname, which(snp.overlap.ctr[snpname,]==0)]
...
pdf("/restricted/projectnb/pulmseq/Allegro/Bronch_microRNA/edrn243/Analysis/LGRC_sandbox/LGRC_Data/Preprocess/gene_mir_ild_new.pdf")
plot(gene.ild["A_23_P360990",], mir.ild["MI0003823_MIMAT0010251",], main=c("Cor coef ", round(cor(gene.ild["A_23_P360990",], mir.ild["MI0003823_MIMAT0010251",]), 3)), xlab="DYDC1", ylab="hsa-miR-449c-5p", pch=19, col="blue")
abline(lm(as.numeric(mir.ild["MI0003823_MIMAT0010251",])~ as.numeric(gene.ild["A_23_P360990",])))
dev.off()

pdf("/restricted/projectnb/pulmseq/Allegro/Bronch_microRNA/edrn243/Analysis/LGRC_sandbox/LGRC_Data/Preprocess/snp_mir_ild_new.pdf")
boxplot(mir.ild["MI0003823_MIMAT0010251", which(snp.overlap.ild["kgp7779523_T",]==0)], mir.ild["MI0003823_MIMAT0010251", which(snp.overlap.ild["kgp7779523_T",]!=0)], col=c("green", "red"), names=c("common SNP", "kgp7779523_T"), ylab=c("hsa-miR-449c-5p expression"))
dev.off()

pdf("/restricted/projectnb/pulmseq/Allegro/Bronch_microRNA/edrn243/Analysis/LGRC_sandbox/LGRC_Data/Preprocess/snp_gene_ild_new.pdf")
boxplot(gene.ild["A_23_P360990", which(snp.overlap.ild["kgp7779523_T",]!=2)], gene.ild["A_23_P360990", which(snp.overlap.ild["kgp7779523_T",]==2)], col=c("darkgreen", "darkred"), names=c("common SNP", "kgp7779523_T"), ylab=c("DYDC1 expression"))
dev.off()
